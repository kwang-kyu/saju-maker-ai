...
function getHealthAgeStrategy(age: number) {
  ...
  if (age <= 34) return "지금은 체력이 있다고 무리하기 쉬운 시기입니다. 밤샘, 불규칙한 식사, 과한 카페인, 운동 부족부터 줄여야 합니다.";
  ...
  return "지금은 무리한 운동보다 낙상 예방, 근력 유지, 식사 조절, 정기검진, 충분한 수면이 중요합니다.";
}
...
결론부터 말씀드리면,
${name}님은 건강을 크게 겁내기보다 생활 리듬을 먼저 바로잡아야 합니다.
...
셋째, 피곤할 때 더 밀어붙이지 말고 짧게라도 쉬는 시간을 넣으십시오.
넷째, 하루 일정을 너무 빡빡하게 잡지 마십시오.
...
어지러움,
수면 문제,
혈압이나 혈당 이상이 있다면 병원 검사를 미루지 않는 것이 좋습니다.
...
- 검사를 미뤄둔 항목이 있다면 예약하십시오.
- 일주일에 하루는 일부러 쉬는 시간을 만드십시오.
