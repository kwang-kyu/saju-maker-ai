...
${name}님에게 맞는 재테크는 한 번에 크게 승부를 보는 방식보다
작게 검증하고, 분산하고, 오래 가져가는 방식입니다.
직업 전략
...
앞으로는 무엇을 할까보다
어떤 방식으로 오래 가져갈 수 있을까를 기준으로 판단하는 것이 좋습니다.
최종적으로 말씀드리면, ${name}님은 늦게 피는 사람이 아니라
