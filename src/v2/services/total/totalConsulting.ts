...
예를 들어 직업에서는 한 번에 완전히 다른 길로 뛰어드는 것보다 기존 경험을 활용해 역할을 확장할 때 안정적입니다. 재테크에서는 큰 수익을 노리는 방식보다 지출, 현금흐름, 보유 기간을 정리할 때 운이 좋아집니다. 관계에서는 많은 사람을 넓게 만나는 것보다 오래 갈 사람을 구분하는 것이 중요합니다.`,
